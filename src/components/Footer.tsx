        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              Premium fitness center dedicated to helping you achieve your
              strongest self. Join our community and transform your life today.
            </p>
            <div className="flex gap-4">
              <SocialLink
                href="https://www.instagram.com/mr_real_strongman_gym?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                icon={<Instagram className="w-5 h-5" />}
                label="Instagram"
              />
              <SocialLink
                href="https://www.facebook.com/share/181NvWrvUs/"
                icon={<Facebook className="w-5 h-5" />}
                label="Facebook"
              />
              <SocialLink
                href="https://youtube.com/@trichystrongmanvijay8457?si=EmWnGH8W22d55GkS"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-6 text-white border-l-4 border-primary pl-3">
              Quick Links
            </h3>
