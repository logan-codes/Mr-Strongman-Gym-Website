  ...
  return (
    <>
      ...
      <main className="pt-16 min-h-screen">
        {/* Hero Section */}
        <section className="relative h-[60vh] min-h-[400px] flex items-center justifycenter overflow-hidden">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto">
              Flexible membership options designed to fit your fitness goals and
              budget
            </p>
          </motion.div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {plans.map((plan, index) => (
                ...
                >
                  <Card
                    className={`glass-card border-0 relative h-full hover:scale-105 transition-transform duration-300 ${
                      plan.popular
                        ? "shadow-2xl border-primary/20 bg-white/80"
                        : ""
                    }`}
                  >
                    {plan.popular && (
