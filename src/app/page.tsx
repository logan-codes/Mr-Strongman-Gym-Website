        ...
        <section className="relative min-h-[600px] flex items-center bg-gradient-to-br from-background to-muted/30">
          <div className="container mx-auto px-4 py-20">
            <div className="max-w-3xl">
              <Badge className="mb-4 bg-primary text-primary-foreground">Transform Your Life</Badge>
              <h1 className="text-5xl md:text-7xl font-bold mb-6">
                Build Your Strength at{" "}
                <span className="text-primary">MR Real StrongMan</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                Premium fitness center in Mannachanallur, Trichy. Professional training, 
                state-of-the-art equipment, and dedicated support for your fitness journey.
              </p>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">Everything you need to achieve your fitness goals</p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Train in a comfortable, women-only environment with certified female trainer V.Ajitha
                <br />
                <strong className="text-foreground">Monday - Saturday: 10:00 AM - 4:00 PM</strong>
              </p>
              <Button size="lg" className="bg-primary hover:bg-primary/90" asChild>
